...
[Download (All)](https://github.com/KnightsOfGlory/WarChat/releases/download/v0.2.16/WarChat-Setup-0.2.16.exe)

## macOS
Architectures supported: Intel, Apple Silicon

[Download (Intel)](https://github.com/KnightsOfGlory/WarChat/releases/download/v0.2.16/WarChat-0.2.16.dmg)

[Download (Apple Silicon)](https://github.com/KnightsOfGlory/WarChat/releases/download/v0.2.16/WarChat-0.2.16-arm64.dmg)

## Linux
Architectures supported: Intel x64, ARM64

[Download (Intel)](https://github.com/KnightsOfGlory/WarChat/releases/download/v0.2.16/WarChat-0.2.16.AppImage)

[Download (ARM)](https://github.com/KnightsOfGlory/WarChat/releases/download/v0.2.16/WarChat-0.2.16-arm64.AppImage)
