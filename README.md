...
[Download (All)](https://github.com/KnightsOfGlory/WarChat/releases/download/v0.2.8/WarChat-Setup-0.2.8.exe)

## macOS
Architectures supported: Intel, Apple Silicon

[Download (Intel)](https://github.com/KnightsOfGlory/WarChat/releases/download/v0.2.8/WarChat-0.2.8.dmg)

[Download (Apple Silicon)](https://github.com/KnightsOfGlory/WarChat/releases/download/v0.2.8/WarChat-0.2.8-arm64.dmg)

## Linux
Architectures supported: Intel x64, ARM64

[Download (Intel)](https://github.com/KnightsOfGlory/WarChat/releases/download/v0.2.8/WarChat-0.2.8.AppImage)

[Download (ARM)](https://github.com/KnightsOfGlory/WarChat/releases/download/v0.2.8/WarChat-0.2.8-arm64.AppImage)
